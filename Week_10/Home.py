...
def GoCyber() -> None:
    """
        Checks if user's logged in, if yes switches page to IT_Tickets.py
        Returns: None
    """
    if st.session_state.logged_in:
        ...
        if st.button("Go to IT tickets"):
            ...
            st.switch_page("pages/1_IT_Tickets.py")  # path is relative to Home.py :contentReference[oaicite:1]{index=1}
